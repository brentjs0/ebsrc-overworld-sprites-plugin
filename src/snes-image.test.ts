...
import * as m from './snes-image';
import { describeExport, describeFunctionExport } from './test-helpers';

const getPixelsPromise = promisify(getPixels);

describe('snes-image.ts', function ()
{
    describeFunctionExport<typeof m>('SnesImage()', function ()
    {
    ...
    describeExport<typeof m>('SnesImage', function ()
    {
        describeFunctionExport<SnesImage>('setPixelValue()', function ()
        {
        ...
        describeFunctionExport<SnesImage>('fill()', function ()
        {
        ...
        describeFunctionExport<SnesImage>('getPaletteColorIndex()', function ()
        {
        ...
        describeFunctionExport<SnesImage>('toPngBuffer()', function ()
        {
